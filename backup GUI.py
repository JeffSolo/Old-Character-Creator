...
class CharacterCreator(object):
	...
	def createVars(self):
		...
		self.traits = {}
		self.traits['STR'] = StringVar()
		self.traits['DEX'] = StringVar()
		self.traits['CON'] = StringVar()
		self.traits['INT'] = StringVar()
		self.traits['WIS'] = StringVar()
		self.traits['CHA'] = StringVar()
		...
		self.CMBabil = {}
		self.Labilnote = {}
		self.abil['STR'] = StringVar()
		self.abil['DEX'] = StringVar()          
		self.abil['CON'] = StringVar()          
		self.abil['INT'] = StringVar()          
		self.abil['WIS'] = StringVar()          
		self.abil['CHA'] = StringVar()          
		self.Mabil['STR'] = StringVar()
		self.Mabil['DEX'] = StringVar()
		self.Mabil['CON'] = StringVar()
		self.Mabil['INT'] = StringVar()
		self.Mabil['WIS'] = StringVar()
		self.Mabil['CHA'] = StringVar()
	...
	def drawAbilities(self):
		...
		self.Bstr = Button(self.root, text="STR", relief=GROOVE, anchor=E, width=4, command=PopUp().Bstr)
		self.Bdex = Button(self.root, text="DEX", relief=GROOVE, anchor=E, width=4)
		self.Bcon = Button(self.root, text="CON", relief=GROOVE, anchor=E, width=4)
		self.Bint = Button(self.root, text="INT", relief=GROOVE, anchor=E, width=4)
		self.Bwis = Button(self.root, text="WIS", relief=GROOVE, anchor=E, width=4)
		self.Bcha = Button(self.root, text="CHA", relief=GROOVE, anchor=E, width=4)

		# Create Ability Entry
		self.CMBabil['STR'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['STR'])
		self.CMBabil['DEX'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['DEX'])
		self.CMBabil['CON'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['CON'])
		self.CMBabil['INT'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['INT'])
		self.CMBabil['WIS'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['WIS'])
		self.CMBabil['CHA'] = ttk.Combobox(self.root, width=4, textvariable=self.abil['CHA'])
		

		# Ability Labels on Grid
		self.Bstr.grid(row=4, column=0, sticky=E)
		self.Bdex.grid(row=5, column=0, sticky=E)
		self.Bcon.grid(row=6, column=0, sticky=E)
		self.Bint.grid(row=7, column=0, sticky=E)
		self.Bwis.grid(row=8, column=0, sticky=E)
		self.Bcha.grid(row=9, column=0, sticky=E)
		# Ability Combobox on Grid
		self.CMBabil['STR'].grid(row=4,column=1, sticky=W)
		self.CMBabil['DEX'].grid(row=5,column=1, sticky=W)
		self.CMBabil['CON'].grid(row=6,column=1, sticky=W)
		self.CMBabil['INT'].grid(row=7,column=1, sticky=W)
		self.CMBabil['WIS'].grid(row=8,column=1, sticky=W)
		self.CMBabil['CHA'].grid(row=9,column=1, sticky=W)
		
		# Create Ability Mod Entry
		self.EstrMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['STR'])
		self.EdexMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['DEX'])
		self.EconMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['CON'])
		self.EintMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['INT'])
		self.EwisMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['WIS'])
		self.EchaMod = Entry(self.root, width=3, state=DISABLED, textvariable=self.Mabil['CHA'])
		# Ability Modifiers on Grid
		self.EstrMod.grid(row=4,column=2, sticky=W)
		self.EdexMod.grid(row=5,column=2, sticky=W)
		self.EconMod.grid(row=6,column=2, sticky=W)
		self.EintMod.grid(row=7,column=2, sticky=W)
		self.EwisMod.grid(row=8,column=2, sticky=W)
		self.EchaMod.grid(row=9,column=2, sticky=W)
		
		# Create Ability Notes Entry
		self.Labilnote['STR']= Label(self.root, width=6, textvariable=self.traits['STR'])
		self.Labilnote['DEX']= Label(self.root, width=6, textvariable=self.traits['DEX'])
		self.Labilnote['CON']= Label(self.root, width=6, textvariable=self.traits['CON'])
		self.Labilnote['INT']= Label(self.root, width=6, textvariable=self.traits['INT'])
		self.Labilnote['WIS']= Label(self.root, width=6, textvariable=self.traits['WIS'])
		self.Labilnote['CHA']= Label(self.root, width=6, textvariable=self.traits['CHA'])
		# Ability Notes on Grid
		self.Labilnote['STR'].grid(row=4,column=3, sticky=EW)
		self.Labilnote['DEX'].grid(row=5,column=3, sticky=EW)
		self.Labilnote['CON'].grid(row=6,column=3, sticky=EW)
		self.Labilnote['INT'].grid(row=7,column=3, sticky=EW)
		self.Labilnote['WIS'].grid(row=8,column=3, sticky=EW)
		self.Labilnote['CHA'].grid(row=9,column=3, sticky=EW)
	...
	def drawInitiative(self):
		...
		self.EinitMisc = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.init['misc'])
	...
	def drawSaves(self):
		...
		self.Eftotal = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.fsave['total'])
		self.Lfeq    = Label(self.root, text="=")
		self.Lfbase  = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.fsave['base'])
		self.Lfplus1 = Label(self.root, text="+")
		self.Lfabilm = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.Mabil['CON'])
		self.Lfplus2 = Label(self.root, text="+")
		self.Lfmagic = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.fsave['magic'])
		self.Lfplus3 = Label(self.root, text="+")
		self.Lfmisc  = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.fsave['misc'])
		
		self.Breflex = Button(self.root, relief=GROOVE, width=12, text="Reflex      (DEX)")
		self.Ertotal = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.rsave['total'])
		self.Lreq = Label(self.root, text="=")
		self.Lrbase = Entry(self.root, width=4, relief=GROOVE, justify=CENTER,  state=DISABLED, textvariable=self.rsave['base'])
		self.Lrplus1 = Label(self.root, text="+")
		self.Lrabilm = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.Mabil['DEX'])
		self.Lrplus2 = Label(self.root, text="+")
		self.Lrmagic = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.rsave['magic'])
		self.Lrplus3 = Label(self.root, text="+")
		self.Lrmisc = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.rsave['misc'])

		self.Bwill = Button(self.root, relief=GROOVE, width=12, text="  Will        (WIS)")
		self.Ewtotal = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.wsave['total'])
		self.Lweq = Label(self.root, text="=")
		self.Lwbase = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.wsave['base'])
		self.Lwplus1 = Label(self.root, text="+")
		self.Lwabilm = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.Mabil['WIS'])
		self.Lwplus2 = Label(self.root, text="+")
		self.Lwmagic = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.wsave['magic'])
		self.Lwplus3 = Label(self.root, text="+")
		self.Lwmisc = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.wsave['misc'])
		...
		self.Lfbase.grid( row=13, column=4) 
		self.Lfplus1.grid(row=13, column=4, sticky=E)
		self.Lfabilm.grid(row=13, column=5, sticky=W)
		self.Lfplus2.grid(row=13, column=5, sticky=E)
		self.Lfmagic.grid(row=13, column=6, sticky=W)
		self.Lfplus3.grid(row=13, column=6, sticky=E)
		self.Lfmisc.grid( row=13, column=7, sticky=W)
		...
		self.Lrbase.grid( row=14, column=4) 
		self.Lrplus1.grid(row=14, column=4, sticky=E)
		self.Lrabilm.grid(row=14, column=5, sticky=W)
		self.Lrplus2.grid(row=14, column=5, sticky=E)
		self.Lrmagic.grid(row=14, column=6, sticky=W)
		self.Lrplus3.grid(row=14, column=6, sticky=E)
		self.Lrmisc.grid( row=14, column=7, sticky=W)
		...
		self.Lwbase.grid( row=15, column=4) 
		self.Lwplus1.grid(row=15, column=4, sticky=E)
		self.Lwabilm.grid(row=15, column=5, sticky=W)
		self.Lwplus2.grid(row=15, column=5, sticky=E)
		self.Lwmagic.grid(row=15, column=6, sticky=W)
		self.Lwplus3.grid(row=15, column=6, sticky=E)
		self.Lwmisc.grid( row=15, column=7, sticky=W)
	...
	def drawAttackBSpellR(self):
		...
		self.EbaseAtk = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, state=DISABLED, textvariable=self.baseAtk)
		self.BspellResist = Button(self.root, relief=GROOVE, width=12, text="Spell Resistance")
		self.EspellResist = Entry(self.root, width=4, relief=GROOVE, justify=CENTER, textvariable=self.spellRes)
		
		self.BbaseAtk.grid(row=19, column=0, columnspan=3, sticky=E)
		self.EbaseAtk.grid(row=19, column=3)
		self.BspellResist.grid(row=19, column=5, columnspan=2) 
		self.EspellResist.grid(row=19, column=7, sticky=W)
